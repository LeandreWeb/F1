<div class="driver-card team_{{ $teamdriver->seasonTeam->team->id }}--border"">
    <div class="driver-info">
        <div class="driver-number team_{{ $teamdriver->seasonTeam->team->id }}--text"># {{ $teamdriver->driver->id }}
        </div>
        <div class="driver-fullname">
            <h4 class="driver-firstname">{{ $teamdriver->driver->Firstname }}</h4>
            <h3 class= "driver-lastname team_{{ $teamdriver->seasonTeam->team->id }}--text">
                {{ $teamdriver->driver->Lastname }}</h3>
        </div>
    </div>
